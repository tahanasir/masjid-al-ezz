...
export function MasjidBoxPrayerTimesDisplay() {
  ...
  const prayers = [
    { name: 'Fajr', adhan: prayerTimes.prayers.fajr.adhan, iqamah: prayerTimes.prayers.fajr.iqamah },
    { name: 'Sunrise', adhan: prayerTimes.prayers.sunrise.adhan, iqamah: null },
    { name: 'Dhuhr', adhan: prayerTimes.prayers.dhuhr.adhan, iqamah: prayerTimes.prayers.dhuhr.iqamah },
    { name: 'Asr', adhan: prayerTimes.prayers.asr.adhan, iqamah: prayerTimes.prayers.asr.iqamah },
    { name: 'Maghrib', adhan: prayerTimes.prayers.maghrib.adhan, iqamah: prayerTimes.prayers.maghrib.iqamah },
    { name: 'Isha', adhan: prayerTimes.prayers.isha.adhan, iqamah: prayerTimes.prayers.isha.iqamah },
  ];
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-md overflow-hidden shadow-sm">
      <div className="px-4 py-3 bg-primary text-white text-center">
        ...
        <p className="text-xs text-white/80 mt-1">{prayerTimes.date} ({prayerTimes.hijriDate})</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-gray-50">
              <th className="py-2 px-3 text-left font-medium text-gray-600">Prayer</th>
              <th className="py-2 px-3 text-center font-medium text-gray-600">Adhan</th>
              <th className="py-2 px-3 text-center font-medium text-gray-600">Iqamah</th>
            </tr>
          </thead>
          <tbody>
