...
const futurePrograms = [
  {
    ...
    description:
      "Equipping youth with practical skills, confidence, and purpose.",
    status: "coming-soon",
  ...
  },
  {
    ...
    description:
      "PMCC is expanding its impact and fostering unity across Peel.",
    status: "planning",
  ...
  },
  {
    ...
    description:
      "A safe, supportive counseling service for youth to navigate personal challenges.",
    status: "planning",
    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="mb-10 text-center">
          <Badge
            variant="outline"
            className="mb-2 border-primary text-primary px-3 py-0.5"
          >
            Roadmap
          </Badge>
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            As our community grows, we're planning to launch these additional
            programs. Subscribe to our newsletter to get updates on launch
            dates.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {futurePrograms.map((program) => (
            ...
            >
              <Card
                className={`p-6 h-full flex flex-col border-transparent shadow-sm ${program.color} hover:shadow-md transition-all duration-300`}
              >
