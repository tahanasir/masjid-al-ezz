      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Select what you're looking for to get to the right information
            quickly
          </p>
        </motion.div>
        ...
        >
          <div className="bg-amber-50 max-w-lg mx-auto p-4 rounded-lg border border-amber-200 flex items-center">
            ...
            <p className="text-sm text-amber-800">
              <span className="font-semibold">Need something else?</span> Visit
              our{" "}
              <Link
                href="/contact"
              ...
              or call us during office hours at{" "}
