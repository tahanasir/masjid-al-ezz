  ...
  const steps = [
    {
      ...
      description: "We're glad you're here! This quick guide will help you navigate our website to find exactly what you need. Let's get started!",
      image: masjidLogo, 
      content: (
        <div className="flex flex-col items-center">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent flex items-end">
              <div className="p-4 text-white">
                ...
                <p className="text-amber-200 text-sm">Peel Muslim Community Center</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <h3 className="font-semibold text-primary text-center mb-3">Our mosque services the local community through:</h3>
            <ul className="space-y-3">
              ...
              >
                ...
                <span className="text-gray-800">Daily prayers and weekly Jumaa</span>
              </motion.li>
              <motion.li 
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: animationComplete ? 1 : 0, x: animationComplete ? 0 : -20 }}
              ...
              >
                ...
                <span className="text-gray-800">Educational programs for all ages</span>
              </motion.li>
              <motion.li 
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: animationComplete ? 1 : 0, x: animationComplete ? 0 : -20 }}
              ...
              >
                ...
                <span className="text-gray-800">Special events and community gatherings</span>
              </motion.li>
              <motion.li 
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: animationComplete ? 1 : 0, x: animationComplete ? 0 : -20 }}
              ...
              >
                ...
                <span className="text-gray-800">Charitable activities and support services</span>
              </motion.li>
            </ul>
          </motion.div>
        </div>
    ...
    },
    {
      ...
      description: "Tell us what you're looking for so we can guide you to the right place.",
      content: (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <Tabs defaultValue="prayer" className="w-full">
            <TabsList className="grid grid-cols-2 md:grid-cols-4 mb-4 shadow-sm">
              <TabsTrigger value="prayer" className="data-[state=active]:bg-primary/10 data-[state=active]:text-primary">Prayer Times</TabsTrigger>
              <TabsTrigger value="events" className="data-[state=active]:bg-amber-500/10 data-[state=active]:text-amber-600">Events</TabsTrigger>
              <TabsTrigger value="programs" className="data-[state=active]:bg-emerald-500/10 data-[state=active]:text-emerald-600">Programs</TabsTrigger>
              <TabsTrigger value="donate" className="data-[state=active]:bg-rose-500/10 data-[state=active]:text-rose-600">Donate</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="prayer" className="p-0 border-0">
              ...
              >
                ...
                <div className="p-5">
                  <p className="text-gray-700 mb-4">Check today's prayer times and weekly schedule for all five daily prayers and Jumaa.</p>
            ...
            <TabsContent value="events" className="p-0 border-0">
              ...
              >
                ...
                <div className="p-5">
                  <p className="text-gray-700 mb-4">Find special events, community gatherings, and regular weekly activities.</p>
                  <div className="bg-white p-3 rounded-lg mb-4 shadow-sm">
                    <div className="font-medium mb-1">Friday Night Tafseer</div>
                    <div className="text-sm text-gray-600">Every Friday after Isha Prayer</div>
                  </div>
            ...
            <TabsContent value="programs" className="p-0 border-0">
              ...
              >
                <div className="bg-emerald-500/10 px-4 py-3 flex items-center border-b border-emerald-500/10">
                  ...
                  <h3 className="font-bold text-emerald-600">Educational Programs</h3>
                </div>
                <div className="p-5">
                  <p className="text-gray-700 mb-4">Explore our structured programs for children, youth, and adults.</p>
                  <div className="bg-white p-3 rounded-lg mb-4 shadow-sm">
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <div>
                        <div className="font-medium mb-1">Youth Boxing Program</div>
                        <div className="text-sm text-gray-600">Registration open for ages 12-18</div>
                      </div>
                    </div>
                  </div>
            ...
            <TabsContent value="donate" className="p-0 border-0">
              ...
              >
                <div className="bg-rose-500/10 px-4 py-3 flex items-center border-b border-rose-500/10">
                  ...
                  <h3 className="font-bold text-rose-600">Support Our Masjid</h3>
                </div>
                <div className="p-5">
                  <p className="text-gray-700 mb-4">Contribute through donations to help sustain and grow our community services.</p>
                  <div className="bg-white p-3 rounded-lg mb-4 shadow-sm text-center">
                    <div className="font-semibold mb-1 text-rose-600">Every donation makes a difference</div>
                    <div className="text-sm text-gray-600">Help us serve the community better</div>
                  </div>
    ...
    {
      title: "Need Help?",
      description: "If you need any assistance or have questions, we're here to help.",
      content: (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="font-bold text-primary text-lg mb-2">Can't find what you're looking for?</h3>
              <p className="text-gray-700 mb-4">
                Visit our contact page for more ways to reach us, or call us directly during office hours.
              </p>
              <a href="/contact">
                <Button variant="outline" className="border-primary text-primary hover:bg-primary/5 group">
                  Contact Us <ChevronRight className="h-4 w-4 ml-1 group-hover:translate-x-0.5 transition-transform" />
                </Button>
              </a>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="font-bold text-indigo-600 text-lg mb-2">Visit Us In Person</h3>
              <div className="bg-white rounded-lg p-4 shadow-sm mb-3">
                <p className="text-gray-700">
                  <span className="block font-medium">Masjid Al-Ezz</span>
                  10 Falconer Dr., Unit 8<br />
                  Mississauga, ON L5N 3L8<br />
                  <span className="font-semibold text-indigo-600">Phone:</span> (123) 456-7890
                </p>
              </div>
              
              <div className="flex space-x-3">
                <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="text-xs bg-indigo-100 hover:bg-indigo-200 text-indigo-700 py-1 px-2 rounded flex items-center transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                  </svg>
                  Get Directions
                </a>
                <a href="tel:1234567890" className="text-xs bg-indigo-100 hover:bg-indigo-200 text-indigo-700 py-1 px-2 rounded flex items-center transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          >
            ...
            <div className="flex justify-center space-x-4 mt-2">
              <a href="https://www.youtube.com/@Masjidalezz" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-600 transition-colors">
              ...
              <a href="https://www.instagram.com/masjidalezz" target="_blank" rel="noopener noreferrer" className="text-pink-600 hover:text-pink-700 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      ...
      <DialogContent className="w-[95%] max-w-[500px] p-0 overflow-hidden rounded-xl shadow-xl border-0 max-h-[85vh] overflow-y-auto">
        ...
        <DialogHeader className="px-4 py-5 pb-3 sm:p-6 sm:pb-3 bg-gradient-to-b from-white to-gray-50/80 relative">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <DialogTitle className="text-xl sm:text-2xl font-serif font-bold text-primary">{activeStep.title}</DialogTitle>
            <DialogDescription className="text-sm sm:text-base mt-1.5">{activeStep.description}</DialogDescription>
          </motion.div>
        </DialogHeader>
