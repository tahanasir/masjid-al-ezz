      ...
      <div className="container mx-auto px-6 pt-12 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center mb-4">
              <img src={logo} alt="Masjid Al-Ezz Logo" className="h-10 mr-3 bg-white p-1 rounded" />
              <span className="font-serif text-xl">Masjid Al-Ezz</span>
            </div>
            <p className="text-white/80 mb-4">
              Peel Muslim Community Center dedicated to serving the spiritual, educational, and social needs of Muslims in our community.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#prayer-times" className="text-white/80 hover:text-white transition-colors">Prayer Times</Link></li>
              <li><Link href="#programs" className="text-white/80 hover:text-white transition-colors">Programs</Link></li>
              ...
              <li><Link href="#donate" className="text-white/80 hover:text-white transition-colors">Donate</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-white/80">10 Falconer Dr., Unit 8<br/>Mississauga, ON L5N 3L8</span>
              </li>
          ...
          <div>
            ...
            <p className="text-white/80 mb-4">Receive updates on prayer times, events, and community news.</p>
            <form className="flex">
              <Input 
                type="email" 
        ...
        <div className="border-t border-white/20 pt-6 mt-8 text-center">
          <p className="text-white/80 text-sm">
            &copy; {new Date().getFullYear()} Masjid Al-Ezz - Peel Muslim Community Center. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
