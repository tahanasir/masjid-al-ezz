...
export default function ProgramDetail() {
  ...
  const handleReminder = () => {
    ...
    const promptEmail = () => {
      const email = window.prompt("Please enter your email to receive notifications about this program:");
      if (email) {
        if (/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) {
          toast({
        ...
        <main className="min-h-screen py-20 bg-gray-50">
          <div className="container mx-auto px-6">
            <div className="text-center">
              <h1 className="text-3xl font-bold text-red-500 mb-4">Program Not Found</h1>
              ...
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                <div className="h-64 overflow-hidden relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-primary/90 via-primary/60 to-transparent flex flex-col justify-end p-8">
                    <Badge className="mb-3 self-start px-3 py-1 bg-amber-400 text-primary hover:bg-amber-500">PROGRAM</Badge>
                    <h1 className="text-3xl font-bold text-white font-serif">{program.title}</h1>
                  </div>
                </div>
                ...
                <div className="p-8">
                  <div className="grid grid-cols-2 gap-4 border-l-4 border-amber-400 pl-4 py-2 mb-8">
                    <div className="flex items-center gap-2 text-primary">
                      ...
                      <div>
                        <p className="text-gray-500 text-xs font-medium">SCHEDULE</p>
                    ...
                    <div className="flex items-center gap-2 text-primary">
                      ...
                      <div>
                        ...
                        <p className="font-semibold">{program.time || "Contact for details"}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 text-primary">
                      ...
                      <div>
                        ...
                        <p className="font-semibold">{program.instructor || "Masjid Staff"}</p>
                      </div>
                    </div>
                  ...
                  <div className="mb-8">
                    <h2 className="text-xl font-bold text-primary mb-4">Program Description</h2>
            ...
            <div className="lg:col-span-1">
              <Card className="shadow-md">
                <CardHeader className="bg-primary text-white">
                  <CardTitle className="text-xl font-serif">Program Registration</CardTitle>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="e.g. 18-25, 26-35, etc." {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="Any relevant experience" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                        ...
                        render={({ field }) => (
                          <FormItem className="flex flex-row items-start space-x-3 space-y-0 mt-4">
                            ...
                            <div className="space-y-1 leading-none">
                              ...
                              <FormDescription>
                                We'll send you information about the program and add you to our mailing list
                              </FormDescription>
                            </div>
                            <FormMessage />
                          </FormItem>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 mt-6">
                <h3 className="text-lg font-bold text-primary mb-3">Need Help?</h3>
