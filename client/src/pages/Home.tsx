            ...
            <div className="text-center py-4 lg:py-8 mb-6">
              ...
              <div className="max-w-md mx-auto">
                <p className="text-white text-base md:text-lg mb-4 md:mb-6">
                  <span className="font-bold text-amber-300">Masjid AlEzz has opened, Alhamdulillah!</span> Your generous support turned a vision into reality. Join us in building our community.
                </p>
              </div>
              <div className="flex flex-wrap gap-2 justify-center mt-2">
                ...
                >
                  <Calendar className="mr-1 md:mr-2 h-3 w-3 md:h-4 md:w-4" /> Prayer Times
                </Button>
                <a href="/programs">
                  <Button className="bg-primary hover:bg-primary/90 text-white rounded-full text-xs md:text-sm px-3 py-1 h-8 md:h-auto">
                    <Users className="mr-1 md:mr-2 h-3 w-3 md:h-4 md:w-4" /> Programs
                  </Button>
                </a>
                <a href="/donate">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-xl overflow-hidden h-full">
                <div className="bg-primary py-2 px-3 text-center">
                  <h2 className="text-base md:text-lg font-serif text-white font-semibold">Today's Prayer Times</h2>
                </div>
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="mt-8 text-center">
                <Link href="/about" className="mr-4">
                  <Button variant="outline" className="border-primary text-primary hover:bg-primary/5 mb-3 sm:mb-0">
      ...
      <Dialog open={isPrayerTimesOpen} onOpenChange={setIsPrayerTimesOpen}>
        <DialogContent className="max-w-2xl w-full mx-auto p-0 overflow-hidden">
          <DialogHeader className="p-6 pb-4">
            <DialogTitle className="text-xl font-serif text-primary">Prayer Times</DialogTitle>
          </DialogHeader>
