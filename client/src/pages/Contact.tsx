...
import { ChevronLeft, Home, MapPin, Phone, Mail, Clock, Calendar, User, MessageSquare } from "lucide-react";
      ...
      <main className="flex-grow">
        ...
        <section className="bg-gradient-to-b from-primary to-primary/80 text-white py-16 md:py-24 mt-4">
          <div className="container mx-auto px-6 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-6">Contact Masjid Al-Ezz</h1>
            <p className="text-lg md:text-xl max-w-3xl mx-auto opacity-90">
              Get in touch with us for inquiries, feedback, or to learn more about our community.
            </p>
          </div>
        </section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
                ...
                <div className="lg:col-span-2">
                  <div className="bg-gray-50 p-8 rounded-lg shadow-sm h-full">
                    ...
                    <div className="space-y-8">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600 mb-1">10 Falconer Dr., Unit 8</p>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500 mt-1">Office hours: 10 AM - 6 PM</p>
                        </div>
                      </div>
                    ...
                    <div className="mt-10 border-t border-gray-200 pt-6">
                      <h3 className="font-bold text-gray-800 mb-3">Key Contacts</h3>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center">
                          ...
                          <div>
                            <p className="font-medium text-gray-800">Imam Mohammed Abdullah</p>
                            <p className="text-sm text-gray-500">imam@masjidalezz.ca</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            <p className="font-medium text-gray-800">Events Coordinator</p>
                            <p className="text-sm text-gray-500">events@masjidalezz.ca</p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="lg:col-span-3">
                  <div className="bg-white p-8 rounded-lg shadow-sm border">
                    <h2 className="text-2xl font-serif text-primary mb-2">Send us a Message</h2>
        ...
        <section className="py-12 bg-gray-50">
          <div className="container mx-auto px-6">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-2xl font-serif text-primary mb-6 text-center">Find Us</h2>
