          ...
          <div className="flex flex-col lg:flex-row items-start justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600 max-w-2xl mb-6">
                Browse our upcoming events at Masjid Al-Ezz. These events are
                open to all community members - no registration required! Just
          ...
          {isLoading ? (
            ...
            <div className="text-center p-12 bg-white rounded-lg shadow">
              ...
              <p className="text-gray-600 mb-6">
                Check back soon for new events at Masjid Al-Ezz.
              </p>
              <Link href="/">
