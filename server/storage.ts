...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    this.createProgram({
      title: "PMCC Sports - Youth Boxing",
      description: "Sports program promoting health and unity. A structured boxing program for youth that teaches discipline, fitness, and self-defense in a safe, Islamic environment.",
      schedule: "Every Tuesday & Thursday",
      time: "5:00 PM - 6:30 PM",
      instructor: "Coach Hamza",
    ...
    this.createProgram({
      title: "Quran Program",
      description: "Transformation through the Quran. A structured Quran memorization and study program focusing on proper tajweed, understanding, and application of Quranic teachings.",
    ...
    this.createProgram({
      ...
      description: "Empowering young sisters with leadership skills. A comprehensive program for Muslim women covering leadership, Islamic knowledge, and personal development.",
      ...
      endDate: new Date(new Date().getFullYear(), new Date().getMonth() + 2, 15), // 15th, 2 months from now
      isActive: true
    });
    ...
    this.createEvent({
      ...
      description: "Weekly Friday congregational prayer with khutbah addressing contemporary issues from an Islamic perspective.",
      date: new Date(now.getFullYear(), now.getMonth(), now.getDate() + (5 - now.getDay() + 7) % 7), // Next Friday
      endDate: new Date(now.getFullYear(), now.getMonth(), now.getDate() + (5 - now.getDay() + 7) % 7),
    ...
    this.createEvent({
      ...
      description: "Join us for a weekly group study of the Quran. Open to all, no registration required.",
      date: new Date(now.getFullYear(), now.getMonth(), now.getDate() + (3 - now.getDay() + 7) % 7), // Next Wednesday
      endDate: new Date(now.getFullYear(), now.getMonth(), now.getDate() + (3 - now.getDay() + 7) % 7),
    ...
    this.createEvent({
      ...
      description: "A place where youth can grow in faith, knowledge, and friendship. Evening session on Quranic interpretation (Tafseer) focusing on selected surahs in a relaxed, youth-friendly atmosphere.",
      date: new Date(now.getFullYear(), now.getMonth(), now.getDate() + (5 - now.getDay() + 7) % 7), // Next Friday
      endDate: new Date(now.getFullYear(), now.getMonth(), now.getDate() + (5 - now.getDay() + 7) % 7),
    ...
    this.createEvent({
      ...
      description: "Join us to plan and organize community iftars for the upcoming month of Ramadan.",
      date: new Date(now.getFullYear(), now.getMonth(), now.getDate() + 15, 19, 0), // 15 days from now at 7pm
      endDate: new Date(now.getFullYear(), now.getMonth(), now.getDate() + 15, 21, 0), // 15 days from now at 9pm
    ...
    this.createEvent({
      ...
      description: "A day filled with fun activities for the whole family, including games, food, and educational workshops.",
      date: new Date(now.getFullYear(), now.getMonth(), now.getDate() + 24, 10, 0), // 24 days from now at 10am
      endDate: new Date(now.getFullYear(), now.getMonth(), now.getDate() + 24, 14, 0), // 24 days from now at 2pm
    ...
    this.createAnnouncement({
      ...
      content: "Join us after Isha prayer this Friday to help plan for the upcoming Ramadan activities and iftar schedule.",
    ...
    this.createBusiness({
      ...
      description: "Family-owned halal restaurant serving authentic Middle Eastern and Mediterranean cuisine since 2010.",
      category: "Food & Dining",
      address: "123 Main Street, Mississauga, ON L5B 1A9",
      phone: "905-555-1234",
      email: "info@halaldelights.com",
      website: "https://www.halaldelights.com",
      logoUrl: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
    ...
    this.createBusiness({
      ...
      description: "Your one-stop shop for all halal meat, international groceries, and fresh produce from local farmers.",
      ...
      logoUrl: "https://images.unsplash.com/photo-1542838132-92c53300491e?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
    ...
    this.createBusiness({
      ...
      description: "Contemporary modest fashion for the modern Muslim woman, featuring exclusive designs and ethical production.",
      category: "Clothing & Fashion",
      address: "789 Cedar Lane, Mississauga, ON L5D 3C7",
      phone: "905-555-9012",
      email: "hello@modestfashion.ca",
      website: "https://www.modestfashion.ca",
      logoUrl: "https://images.unsplash.com/photo-1589483232097-11d9a01184e3?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
    ...
    this.createBusiness({
      ...
      description: "Ethical financial planning, investment advice, and Islamic mortgage solutions compliant with Sharia principles.",
      ...
      logoUrl: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
    ...
    this.createBusiness({
      ...
      description: "Muslim-owned tech company offering web development, mobile apps, and IT consulting services to small businesses.",
      category: "Technology",
      address: "222 Tech Boulevard, Mississauga, ON L5F 5E5",
      phone: "905-555-7890",
      email: "support@salamtech.ca",
      website: "https://www.salamtech.ca",
      logoUrl: "https://images.unsplash.com/photo-1581089778245-3ce67677f718?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
  ...
  async getAnnouncements(active?: boolean): Promise<Announcement[]> {
    ...
    if (active !== undefined) {
      return announcements.filter(announcement => announcement.isActive === active);
    }
  ...
  async createProgram(program: InsertProgram): Promise<Program> {
    ...
    const newProgram: Program = { 
      ...
      registrationRequired: program.registrationRequired !== undefined ? program.registrationRequired : true,
  ...
  async getFeaturedBusinesses(): Promise<Business[]> {
    const businesses = Array.from(this.businesses.values());
    return businesses.filter(business => business.featured && business.active);
  }
